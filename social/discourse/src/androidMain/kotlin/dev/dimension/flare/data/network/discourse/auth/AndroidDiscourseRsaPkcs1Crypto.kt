...
/** Android Java Security implementation for one-time Discourse User API Key authorization. */
public class AndroidDiscourseRsaPkcs1Crypto public constructor(
    ...
    override suspend fun generate(minimumKeySizeBits: Int): DiscourseRsaPkcs1KeyPair =
        withContext(cryptoDispatcher) {
            ...
            try {
                ...
                throw AndroidDiscourseRsaCryptoException("Android RSA key generation failed", error)
            }
        }
        ...
        try {
            return withContext(cryptoDispatcher) {
                try {
                    ...
                    throw AndroidDiscourseRsaCryptoException("Android RSA decryption failed", error)
                }
            }
        } finally {
...
/** Failure from Android's installed cryptographic provider, without sensitive values in messages. */
public class AndroidDiscourseRsaCryptoException public constructor(
    message: String,
    cause: Throwable,
